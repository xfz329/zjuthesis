...
\begin{center}
    \begin{tabularx}{\linewidth}{ l >{\raggedleft}X }
        % 学位论文作者签名: \includegraphics[width=.3\linewidth]{signature/jiangfeng_cn} &
        学位论文作者签名:  &
...
%         学位论文作者签名:  &   \includegraphics[width=.5\linewidth]{signature/jiangfeng_cn} &
%         导师签名:   &     \includegraphics[width=.64\linewidth]{signature/chenhang_cn}\\
%     \end{tabularx}
% \end{center}
...
\begin{center}
    \begin{tabularx}{\linewidth}{ X X }
        ...
        导师签名: \\
        ~ & ~ \\
        签字日期： \multido{}{4}{\quad} 2024年  1月  10日 &
        签字日期： \multido{}{4}{\quad} 2024年  1月  10日
    \end{tabularx}
\end{center}
