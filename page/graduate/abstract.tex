...
本论文构建了包含PE\textcolor{red}{病发}孕妇与正常妊娠孕妇的PPG数据集，设计了PPG多维度时域特征集与PPG采样序列时域特征集，将
...
In this thesis, we construct a PPG dataset containing pregnant women \textcolor{red}{suffered from PE together with} normal pregnancy, design a multidimensional time-domain feature set of PPG and 
...
On the other hand, as the software carrier of the above research work, this thesis develops a modular PPG-based PE identification and analysis software 
