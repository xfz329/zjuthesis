...
当地某妇产科医院进行了临床数据采集实验。\textcolor{red}{实验通过了%浙江大学医学院附属妇产科医院医学伦理委员会的审查（审查编号：20170131），所有被试孕妇均知晓研究目的及具体实验流程，并签署了知情同意书。
...
\begin{figure}[htbp]
    \centering
    \subfigure[重\textcolor{red}{搏}波明显的PPG波形示意图]{
    \includegraphics[width=5.5cm]{pulse_preprocess/ri1}
    }
    \quad
    \subfigure[重\textcolor{red}{搏}波不明显的PPG波形示意图]{
...
\begin{figure}[htbp]
    \centering
    \subfigure[\label{fig:ri1}重\textcolor{red}{搏}波明显的PPG波形示意图]{
    \includegraphics[width=6cm]{pulse_preprocess/ri1}
    }
    \quad
    \subfigure[\label{fig:ri2}重\textcolor{red}{搏}波不明显的PPG波形示意图]{
...
\textcolor{red}{PWV}是指心脏每次搏动射血产生的沿大
