...
\end{equation}
特别地，\autoref{equ:character}中$\pm$的取值视拐点$P1$与峰值点的相对位置而定。图\autoref{fig:aix1}中的拐点在峰值点左侧，AIX符号取正，表示主波峰是经过叠加得到的；而图\autoref{fig:aix2}中的拐点在峰值点右侧，AIX符号取负，
表明主波峰未得到“增强”。
...
类似地，可以得到脉搏传导时间（Pulse Transit Time，PTT）。
