...
\begin{center}
    ...
    \begin{longtable}{m{4cm}<{\centering}m{4cm}<{\centering}m{4cm}<{\centering}m{2cm}<{\centering}}
        ...
        \colorrowc 体重（kg） & \textbf{75.7±12.9} & \textbf{67.1±8.2} & 0.002* \\
        \colorrowa BMI（kg/cm） & \textbf{30.2±4.5} & \textbf{26.2±3.3} & <0.001* \\
        \colorrowc 收缩压（mmhg） & \textbf{160.1±19.5} & \textbf{111.2±9.8} & <0.001* \\
        \colorrowa 舒张压（mmhg） & \textbf{96.1±14.5} & \textbf{66.8±10.4} & <0.001* \\
