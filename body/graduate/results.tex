...
\begin{figure}[htbp]
      \centering
      \includegraphics[width=0.85\linewidth]{results/frameworks5}
...
\begin{figure}[htbp]
      ...
      \includegraphics[width=6.5cm]{results/contrast_auc}
      }
      \quad
      \subfigure[\label{fig:cmdl2}各模型在超参数优化前后的性能对比]{
      \includegraphics[width=6.5cm]{results/contrast_acc}
      }
...
\begin{figure}[htbp]
      \centering
      \includegraphics[width=.55\linewidth]{results/model_roc}
