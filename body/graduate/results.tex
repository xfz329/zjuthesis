...
\begin{center}
      ...
      \begin{longtable}{m{0.6cm}<{\centering}m{2cm}<{\centering}m{0.8cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}}
            ...
            \topline
            \colorhead & &  & \multicolumn{5}{c}{\textbf{训练集}} & \multicolumn{4}{c}{\textbf{测试集}}                                                                                                                                                                                                      \\
            \colorhead \multirow{-2}{*}{\textbf{序号}} & \multirow{-2}{*}{\textbf{模型类型}} & \multirow{-2}{*}{\tabincell{c}{\textbf{训练}\\ \textbf{时间}}} &  \textbf{精确率} &  \textbf{召回率} &  \textbf{F1值} &  \textbf{准确率} &  \textbf{AUC}  &  \textbf{精确率} &  \textbf{召回率} &  \textbf{F1值} &  \textbf{准确率}    \\
            \midline
            \endfirsthead
            \caption[]{(续)}\\
            \midline
            ...
            \bottomline
            \endlastfoot
            \colorrowa 1 & 随机梯度下降        &   6.17 s   & 87.2\% & 68.9\% & 77.0\% & 75.5\% & 0.876 & \cellcolor{pink} 74.8\% & 97.7\% & 84.7\% & 79.0\% \\
            \colorrowc 2 & 决策树             &   5.24 s  & 91.1\% & 83.0\% & 86.9\% & 85.1\% & 0.907 & 93.6\% & 81.4\% & 87.1\% & 85.6\% \\
            \colorrowa 3 & K近邻              &   3.08 s    & \cellcolor{pink} 94.7\% & \cellcolor{pink} 93.7\% & \cellcolor{pink} 94.2\% & \cellcolor{pink} 93.1\% & \cellcolor{pink} 0.974  & 95.4\% & 93.3\% & 94.3\% & 93.3\% \\
            \colorrowc 4 & \tabincell{c}{高斯朴素\\贝叶斯 }     &   \cellcolor{pink}1.22 s  & 87.9\% & 63.9\% & 74.0\% & 73.2\% & \cellcolor{pink}0.838  & 90.1\% & \cellcolor{pink} 65.0\% & 75.5\% & 74.9\% \\
            \colorrowa 5 & 逻辑回归           &   \cellcolor{pink}203.00 s  & 90.2\% & 90.7\% & 90.4\% & 88.6\% & 0.950 & 93.3\% & 93.0\% & 93.1\% & 91.8\% \\
            \colorrowc 6 & \tabincell{c}{线性支持\\向量机}     &   47.22 s  & 79.7\% & 93.2\% & 86.0\% & 81.9\% & 0.917 & 95.9\% & 81.9\% & 88.3\% & 87.1\% \\
            \colorrowa 7 & 核支持向量机       &   60.28 s  & 82.5\% & 90.3\% & 86.2\% & 82.8\% & 0.916 & 84.9\% & 91.4\% & 88.0\% & 85.2\% \\
            \colorrowc 8 & C-支持向量机       &   42.47 s  & 84.3\% & 90.5\% & 87.3\% & 84.3\% & 0.929 & 87.1\% & 90.8\% & 88.9\% & 86.5\% \\
            \colorrowa 9 & 多层感知机         &   26.8 s  & 83.5\% & 75.8\% & 79.5\% & 76.6\% & 0.905 & 89.3\% & 91.1\% & 90.2\% & 88.2\% \\
      \end{longtable}
\end{center}
\vspace{-2em}
...
\begin{center}
      ...
      \begin{longtable}{m{1cm}<{\centering}m{4cm}<{\centering}m{6.5cm}<{\centering}m{4cm}<{\centering}}
            ...
            \topline
            \colorhead \textbf{序号} & \textbf{模型类型} & \textbf{超参数组合值域}     &     \textbf{最优超参数}\\
            \midline
            \endfirsthead
            \caption[]{(续)}\\ 
            \midline
            ...
            \bottomline
            \endlastfoot
            \colorrowa 1 & 随机梯度下降    & \begin{tabular}[c]{@{}l@{}}loss:{[}\textbf{hinge}, log\_loss,   \\ log, modified\_huber, \\ squared\_hinge, perceptron, \\ squared\_error,  huber,\\  epsilon\_insensitive, \\ squared\_epsilon\_insensitive{]},\\    penalty:{[}\textbf{l2},l1,elasticnet{]},\\   alpha:{[}0.001,\textbf{0.0001},0.00001{]}\end{tabular} &  \begin{tabular}[c]{@{}l@{}}alpha=0.001, \\ loss=squared\_hinge,   \\ penalty=elasticnet\end{tabular}     \\
            \colorrowc 2 & 高斯朴素贝叶斯   & var\_smoothing:{[}1e-5,1e-7,\textbf{1e-9},1e-11{]}             & var\_smoothing=1e-7                     \\
            \colorrowa 3 & 决策树           & \begin{tabular}[c]{@{}l@{}}criterion:{[}\textbf{gini},entropy,log\_loss{]},\\  splitter:{[}\textbf{best},random{]},\\     max\_depth:{[}\textbf{3},4,5{]},\\  max\_features:{[}sqrt,log2,\textbf{None}{]}\end{tabular}        & \begin{tabular}[c]{@{}l@{}}criterion=entropy,\\ splitter=random,\\ max\_depth=5, \\ max\_features=None\end{tabular}         \\
            \colorrowc 4 & K近邻            & \begin{tabular}[c]{@{}l@{}}n\_neighbors:{[}3,\textbf{5},7,9{]},\\    weights:{[}\textbf{uniform},distance{]}\end{tabular}       & \begin{tabular}[c]{@{}l@{}}n\_neighbors=9,\\  weights=distance\end{tabular}             \\
      \end{longtable}
\end{center}
\vspace{-0.8cm}
...
\begin{center}
      ...
      \begin{longtable}{m{1cm}<{\centering}m{1.5cm}<{\centering}m{1.5cm}<{\centering}m{1cm}<{\centering}m{1.5cm}<{\centering}m{1.5cm}<{\centering}m{1cm}<{\centering}m{1.5cm}<{\centering}m{1.5cm}<{\centering}}
            ...
            \label{tab:rf_dr_1}\\
            \topline
            \colorhead \textbf{序号}&\textbf{特征名}&\textbf{贡献度}&\textbf{特征名}&\textbf{序号}&\textbf{贡献度}&\textbf{序号}&\textbf{特征名}&\textbf{贡献度}\\
            \midline
            \endfirsthead
            \caption[]{(续)}\\
            \midline
            ...
            \bottomline
            \endlastfoot
            \colorrowc 1 & \cellcolor{cyan}CVALF\_9                         & \cellcolor{cyan}4.6\%                           &    2   & \cellcolor{cyan}LVRF\_9                          & \cellcolor{cyan}3.4\%                 &      3           & SVD\_10                          & 3.0\%                            \\
            \colorrowc 4 & \cellcolor{cyan}SVAF\_10                         & \cellcolor{cyan}2.5\%                           &    5   & \cellcolor{cyan}LVALF\_7                         & \cellcolor{cyan}2.4\%                 &      6           & SVAT\_10                         & 2.3\%                            \\
            \colorrowc 7 & \cellcolor{cyan}CVRF\_11                         & \cellcolor{cyan}2.1\%                           &    8   & \cellcolor{pink}SVAR\_10                         & \cellcolor{pink}1.8\%                 &      9           & STDZ\_3                          & 1.6\%                            \\
            \colorrowc 10 & \cellcolor{cyan}LVRF\_8                          & \cellcolor{cyan}1.6\%                          &    11    & \cellcolor{cyan}LVALF\_6                         & \cellcolor{cyan}1.6\%                &      12            & CVD\_11                          & 1.6\%                            \\
            \colorrowc 13 & STDZ\_1                                          & 1.5\%                                          &    14    & \cellcolor{cyan}CVALF\_8                         & \cellcolor{cyan}1.5\%                &      15            & SVD\_9                           & 1.4\%                            \\
            \colorrowc 16 & \cellcolor{pink}SVAAR\_10                        & \cellcolor{pink}1.4\%                          &    17    & \cellcolor{cyan}CVALF\_1                         & \cellcolor{cyan}1.4\%                &      18            & \cellcolor{pink}SVAAR\_8                         & \cellcolor{pink}1.3\%                            \\
            \colorrowc 19 & SVD\_8                                           & 1.1\%                                          &    20    & \cellcolor{pink}SVAR\_9                          & \cellcolor{pink}1.0\%                &      21            & \cellcolor{cyan}SVAF\_9                          & \cellcolor{cyan}1.0\%                            \\
            \colorrowc 22 & \cellcolor{cyan}CVAAF\_1                         & \cellcolor{cyan}1.0\%                          &    23    & \cellcolor{cyan}LVLF\_8                          & \cellcolor{cyan}0.9\%                &      24            & SVAT\_8                          & 0.9\%                            \\
            \colorrowc 25 & \cellcolor{cyan}CVRF\_1                          & \cellcolor{cyan}0.9\%                          &    26    & \cellcolor{cyan}CVAAF\_2                         & \cellcolor{cyan}0.9\%                &      27            & \cellcolor{pink}SVAR\_8                          & \cellcolor{pink}0.8\%                            \\
            \colorrowc 28 & \cellcolor{cyan}SVAF\_2                          & \cellcolor{cyan}0.8\%                          &    29    & \cellcolor{pink}CVRR\_11                         & \cellcolor{pink}0.8\%                &      30            & \cellcolor{cyan}LVRF\_1                          & \cellcolor{cyan}0.7\%                            \\
            \colorrowc 31 & \cellcolor{pink}SVSR\_7                          & \cellcolor{pink}0.7\%                          &    32    & \cellcolor{cyan}CVRF\_3                          & \cellcolor{cyan}0.7\%                &      33            & \cellcolor{pink}CVALR\_10                        & \cellcolor{pink}0.7\%                            \\
            \colorrowc 34 & \cellcolor{cyan}CVALF\_7                         & \cellcolor{cyan}0.7\%                          &    35    & \cellcolor{pink}CVAAR\_5                         & \cellcolor{pink}0.7\%                &      36            & \cellcolor{cyan}LVRF\_2                          & \cellcolor{cyan}0.6\%                           
      \end{longtable}
\end{center}
\vspace{-0.8cm}
...
\begin{center}
      ...
      \begin{longtable}{m{0.8cm}<{\centering}m{2cm}<{\centering}m{1.3cm}<{\centering}m{1.3cm}<{\centering}m{1.6cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}}
            ...
            \colorhead \multirow{-2}{*}{\textbf{序号}}&\textbf{贡献度比例} & \textbf{特征数量} & \textbf{数量比例} & \multirow{-2}{*}{\textbf{训练时间}}  & \multirow{-2}{*}{\textbf{AUC}}   & \textbf{精确率} & \textbf{召回率} & \textbf{F1值} & \textbf{准确率} \\
            \midline
            \endfirsthead
            \caption[]{(续)}\\
            \midline
            ...
            \bottomline
            \endlastfoot
            \colorrowa 1 & 100.0\%        & 286           & 100.0\%       & 41.30    & 0.990      & 98.0\%       & 97.0\%       & 97.5\%       & 97.0\%       \\
            \colorrowc 2 & 90.0\%         & 162           & 56.6\%        & 38.11    & 0.991      & 98.1\%       & 97.3\%       & 97.8\%       & 97.3\%       \\
            \colorrowa 3 & 80.0\%         & 108           & 37.8\%        & 29.33    & 0.993      & 97.7\%       & 97.2\%       & 97.5\%       & 97.0\%       \\
            \colorrowc 4 & 70.0\%         & 74            & 25.9\%        & 23.67    & 0.993      & 98.1\%       & 97.5\%       & 97.8\%       & 97.4\%       \\
            \colorrowa 5 & 60.0\%         & 51            & 17.8\%        & 20.91    & 0.994      & 98.3\%       & 97.1\%       & 97.7\%       & 97.3\%       \\
            \colorrowc 6 & 50.0\%         & 34            & 11.9\%        & 15.17    & 0.993      & 97.8\%       & 97.0\%       & 97.4\%       & 97.0\%       \\
            \colorrowa 7 & 40.0\%         & 21            & 7.3\%         & 11.90    & 0.993      & 97.7\%       & 96.8\%       & 97.3\%       & 96.8\%       \\
      \end{longtable}
\end{center}
\vspace{-0.8cm}
...
\begin{center}
      ...
      \begin{longtable}{m{0.8cm}<{\centering}m{1.5cm}<{\centering}m{1.1cm}<{\centering}m{0.9cm}<{\centering}m{0.9cm}<{\centering}m{0.9cm}<{\centering}m{0.9cm}<{\centering}m{0.9cm}<{\centering}m{0.9cm}<{\centering}m{0.9cm}<{\centering}m{0.9cm}<{\centering}m{0.9cm}<{\centering}}
            ...
            \topline
            \colorhead & &  & \multicolumn{5}{c}{\textbf{训练集}} & \multicolumn{4}{c}{\textbf{测试集}}                                                                                                                                                                                                      \\
            \colorhead \multirow{-2}{*}{\textbf{序号}} & \multirow{-2}{*}{\textbf{模型类型}} & \multirow{-2}{*}{\textbf{训练时间}}  &  \textbf{精确率} &  \textbf{召回率} &  \textbf{F1值} &  \textbf{准确率} &  \textbf{AUC}  &  \textbf{精确率} &  \textbf{召回率} &  \textbf{F1值} &  \textbf{准确率}    \\
            \midline
            \endfirsthead
            \caption[]{(续)}\\
            \midline
            ...
            \bottomline
            \endlastfoot
            \colorrowa 1 & K近邻      &   4.08 s   & 88.0\% & 76.0\% &81.6\% & 80.0\% & 0.870 & 81.5\% & 85.6\% & 83.5\% & 78.3\% \\
            \colorrowc 2 & 决策树      &   1.44 s  & 84.0\% & 80.9\% & 82.4\% & 79.8\% & 0.862 & 69.0\% & 86.1\% & 76.6\% & 66.3\% \\
            \colorrowa 3 & 随机森林      &   50.03 s  & 90.6\% & 80.6\% & 85.3\% & 83.8\% & 0.929 & 79.5\% & 90.9\% & 84.8\% & 79.1\% \\
      \end{longtable}
\end{center}
\vspace{-0.8cm}
...
\begin{center}
      ...
      \begin{longtable}{m{0.8cm}<{\centering}m{1.2cm}<{\centering}m{1cm}<{\centering}m{1.2cm}<{\centering}m{1.5cm}<{\centering}m{1.5cm}<{\centering}m{1.5cm}<{\centering}m{1.5cm}<{\centering}m{1.5cm}<{\centering}m{1.5cm}<{\centering}m{1cm}<{\centering}}
            ...
            \colorhead \multirow{-2}{*}{\textbf{序号}}  & \multirow{-2}{*}{\textbf{被试孕妇}}  &     \multirow{-2}{*}{\textbf{PE状态}} &   \multirow{-2}{*}{\textbf{波形总数}}   & \textbf{预测数目}     & \textbf{预测比例}       & \textbf{预测数目}     & \textbf{预测比例}       & \textbf{预测数目}     & \textbf{预测比例}             \\
            \midline
            \endfirsthead
            \caption[]{(续)}\\
            \midline
            ...
            \bottomline
            \endlastfoot
            \colorrowa  1 & cmf       & 0           & 88                    & 54         & 61.4\%     & 85         & 96.6\%     & 53         & 60.2\%                                                                            \\
            \colorrowc  2 & lxx       & 0           & 63                    & 32         & 50.8\%     & 53         & 84.1\%     & 34         & 54.0\%                                                                            \\
            \colorrowa  3 & shs       & 0           & 112                   & 37         & 33.0\%     & 105        & 93.8\%     & 55         & 49.1\%                                                                            \\
            \colorrowc  4 & sxh       & 0           & 95                    & 27         & 28.4\%     & 64         & 67.4\%     & 21         & 22.1\%                                                                            \\
            \colorrowa  5 & wdq       & 0           & 36                    & 0          & 0.0\%      & 0          & 0.0\%      & 0          & 0.0\%                                                                             \\
            \colorrowc  6 & wsj       & 0           & 78                    & 0          & 0.0\%      & 2          & 2.6\%      & 0          & 0.0\%                                                                             \\
            \colorrowa  7 & ygy       & 0           & 75                    & 40         & 53.3\%     & 70         & 93.3\%     & 67         & 89.3\%                                                                            \\
            \colorrowc  8 & gmn       & 1           & 139                   & 106        & 76.3\%     & 135        & 97.1\%     & 109        & 78.4\%                                                                            \\
            \colorrowa  9 & ty        & 1           & 98                    & 97         & 99.0\%     & 97         & 99.0\%     & 97         & 99.0\%                                                                            \\
            \colorrowc  10 & wjh       & 1           & 86                    & 86         & 100.0\%    & 86         & 100.0\%    & 86         & 100.0\%                                                                           \\
            \colorrowa  11 & xjf       & 1           & 106                   & 23         & 21.7\%     & 59         & 55.7\%     & 87         & 82.1\%                                                                            \\
            \colorrowc  12 & ywy       & 1           & 111                   & 110        & 99.1\%     & 111        & 100.0\%    & 111        & 100.0\%                                                                           \\
            \colorrowa  13 & yxl       & 1           & 110                   & 110        & 100.0\%    & 108        & 98.2\%     & 110        & 100.0\%                                                                           \\
            \colorrowc  14 & zdq       & 1           & 89                    & 81         & 91.0\%     & 84         & 94.4\%     & 82         & 92.1\%                                                                            \\
            \colorrowa  15 & zl        & 1           & 152                   & 137        & 90.1\%     & 75         & 49.3\%     & 120        & 78.9\%                                                                            \\
            \colorrowc  16 & zyy       & 1           & 89                    & 89         & 100.0\%    & 89         & 100.0\%    & 89         & 100.0\%                                                                            \\    
      \end{longtable}
\end{center}
\vspace{-0.8cm}
...
\begin{center}
      ...
      \begin{longtable}{m{1cm}<{\centering}m{2.8cm}<{\centering}m{2cm}<{\centering}m{1.5cm}<{\centering}m{1.8cm}<{\centering}m{1.8cm}<{\centering}}
            ...
            \topline
            \colorhead \textbf{序号} & \textbf{机器学习算法}&\textbf{最佳阈值}&\textbf{混淆矩阵}&\textbf{准确率}&\textbf{AUC}\\
            \midline
            \endfirsthead
            \caption[]{(续)}\\ 
            \topline
            ...
            \bottomline
            \endlastfoot
            \colorrowa 1 & 决策树       & 0.969    &     $\left[ \begin{array}{cc} 6 & 3 \\ 0 & 7 \end{array} \right]$  & 81.3\% & 0.825  \\
            \colorrowc 2 & K近邻       & 0.907     &     $\left[ \begin{array}{cc} 6 & 3 \\ 0 & 7 \end{array} \right]$  & 81.3\% & 0.921 \\
            \colorrowa 3 & 随机森林     & 0.688    &     $\left[ \begin{array}{cc} 9 & 0 \\ 1 & 6 \end{array} \right]$  & 93.8\% & 0.952  \\
      \end{longtable}
\end{center}
\vspace{-1.4cm}
...
\begin{center}
      ...
      \begin{longtable}{m{0.4cm}<{\centering}m{0.6cm}<{\centering}m{1.2cm}<{\centering}m{0.6cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{0.9cm}<{\centering}m{1cm}<{\centering}m{0.9cm}<{\centering}m{1cm}<{\centering}m{1cm}<{\centering}m{0.9cm}<{\centering}m{1cm}<{\centering}}
            ...
            \colorhead \multirow{-2}{*}{\textbf{序号}}  &\multirow{-2}{*}{\tabincell{c}{\textbf{对齐}\\\textbf{方式}}} &\multirow{-2}{*}{\tabincell{c}{\textbf{模型}\\\textbf{类型}}}&\multirow{-2}{*}{\tabincell{c}{\textbf{训练}\\\textbf{时间}}}  & \textbf{精确率} & \textbf{召回率}& \textbf{F1值} & \textbf{准确率}& \textbf{AUC} & \textbf{精确率} & \textbf{召回率} & \textbf{F1值}& \textbf{准确率} \\
            \midline
            \endfirsthead
            \caption[]{(续)}\\
            \midline
            ...
            \bottomline
            \endlastfoot
            \colorrowa 1 & CS & 决策树      & 4.13    & 83.9\%  & 88.6\%  & 86.1\% & 83.0\% & 0.914   & 86.6\%  & 90.9\%  & 88.7\% & 86.2\% \\
            \colorrowc 2 & CS & K近邻     & 2.81     & 93.4\%  & 90.0\%  & 91.4\% & 90.0\%   & 0.967  & 94.5\%   & 90.7\%   & 92.6\% & 91.4\% \\
            \colorrowa 3 & CS & \tabincell{c}{随机\\森林}   & 23.23   & 93.3\%  & 92.8\% & 93.0\% & 91.7\%  & 0.977 & 94.8\% & 94.5\%   & 94.6\% & 93.6\% \\
            \colorrowc 4 & RS & 决策树     & 6.77   & 85.6\%  & 85.2\%  & 85.4\% & 82.6\% & 0.902    & 88.3\%  & 84.1\%  & 86.2\% & 83.9\% \\
            \colorrowa 5 & RS & K近邻     & 3.90    & 91.5\%  & 89.5\%  & 90.5\% & 88.8\%   & 0.957  & 94.2\%   & 91.2\%   & 92.9\% & 91.6\% \\
            \colorrowc 6 & RS & \tabincell{c}{随机\\森林}    & 51.57    & 91.4\%  & 91.9\% & 91.6\% & 90.0\%  & 0.967  & 93.4\% & 94.0\%   & 93.7\% & 92.5\% \\
      \end{longtable}
\end{center}
\vspace{-0.8cm}
...
\begin{center}
      ...
      \begin{longtable}{m{1.5cm}<{\centering}m{1.5cm}<{\centering}m{2cm}<{\centering}m{1.5cm}<{\centering}m{1.5cm}<{\centering}m{1.5cm}<{\centering}m{2cm}<{\centering}}
            ...
            \colorrowc PPGSSTFS & PR & CS &  93.6\% & 91.4\% & 86.2\% & / \\
            \colorrowc PPGSSTFS & PR & RS &  92.5\% & 91.6\% & 83.9\% & /\\
            \colorrowc PPGSSTFS & SR & CS &  74.3\% & 78.3\% & 67.5\% & 按波形统计\\
            \colorrowc PPGSSTFS & SR & RS &  77.0\% & 74.7\% & 71.6\%& 按被试统计\\
            \colorrowc PPGSSTFS & SR & CS &  81.3\% & 81.3\% & 81.3\%& 按波形统计\\
            \colorrowc PPGSSTFS & SR & RS &  87.5\% & 81.3\% & 87.5\%& 按被试统计\\
      \end{longtable}
\end{center}
\vspace{-0.8cm} 
