...
软件系统一共设计了四张数据表（Table）来解决这一问题。这些数据表之间的相互关联关系如\autoref{fig:data_table_relationship}所示。
...
以后可能涉及的其他项目的存储可以更加需要调整这两个字段意义。值得一提的是，数据表中额外增加了isDeleted字段用以处理数据记录的删除，当需要删除
