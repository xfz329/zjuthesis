...
在上述基础上，针对本论文数据采集得到的79例被试人员的PPG数据，分别在测试这些数据经由PC客户端与Android客户端的延迟后，可得到所有数据文件在与云服务器端通讯的平均延时。
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{software/mysql}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{software/feature_db}
