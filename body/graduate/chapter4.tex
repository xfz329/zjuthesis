...
可以看到复核模块的各审核单项标准均有着较好的识别纠错能力，单项准确性均在96\%以上，特异性更是均在99\%以上。值得一提的是，复核标准功率与标准差在定义上就有着极高的相似性，检测结果也高度极为相似。
...
此外，\autoref{tab:checkevaluation}中结果表明，对本测试数据而言，两种投票决策机制表现堪称完美，均能对PPG信号中干扰实现完美甄别。这也从侧面说明现阶段采用的功率、标准差、时间与基线等四个复核标准
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\linewidth}{cccccX<{\centering}X<{\centering}X<{\centering}X<{\centering}}
        ...
        \midrule
            ...
            基线    & 7     & 1     & 4     & 103   & 96.5\% & 87.5\% & 63.6\% & 99.0\% \\
