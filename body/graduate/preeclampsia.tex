\chapter{子痫前期的生理学基础}
\section{引言}
在全身麻醉手术中，手术操作产生的伤害性刺激会引起机体一系列复杂的生理、病理反应，会对患者精神心理状态、神经内分泌系统、循环系统、呼吸系统、
消化系统、泌尿系统等造成不良影响，而适量的镇痛药物有助于减轻伤害性刺激对于人体的伤害。本章首先阐述镇痛药物的作用机制、伤害性刺激和镇痛对
于脑和自主神经系统的影响及具体表现，并根据伤害性刺激引起的生理学变化分析脉搏波信号的潜力和优势。然后介绍脉搏波的产生机理、容积脉搏波血流模型、
以及光电容积脉搏波的检测方法和波形特征。
...
故有学者提出子痫前期-子痫综合征（preeclampsia-eclampsia syndrome）的概念\cite{a_hospital,OAG9}。

具体而言，当孕妇患有子痫前期后，其全身器官可能出现的病生理变化有。PE对孕妇下列各器官组织的正常功能均有一定的影响。
...
作为人体电生理内源信号的一种，脉搏波不仅拥有其鲜明的个性特点，还拥有一般医学信号的共性特征。
...
一般认为，PPG信号也是平稳随机信号的一种，和其他人体内源信号类似，有着医学信号的以下特点\cite{Ma2015,Qiu2012,Naraharisetti2011,Miao2020,LMX2019}。
...
在脉搏波信号的分析研究中，搏动不止的心脏显然是这一通讯系统的信源，人体内各脏器系统、组织等可以看成是一个复杂的黑箱编码系统，人体表面丰富的毛细血管则是
该通讯过程中的信道，若因子痫前期等疾病引起了人体毛细血管等系统的生理性变化可以折合成对信道的干扰噪声。所以，脉搏波信号可以看成是反映信源心脏功能与信道基本特性的消息载体。\textbf{在此基础上，脉搏波的描述过程即可视为在编码规则不明确（黑箱模型）的前提
...
\section{小结}
本章首先从生理学角度解释了镇痛药物阻断痛觉感受传递的本质，介绍了伤害性刺激和镇痛对脑、自主神经系统的影响。其中，着重分析了脑电信号、
心电信号及脉搏信号在伤害性刺激下的变化及其在镇痛水平监测方面的潜力。对比信号检测的便捷性、成本消耗及全身麻醉术中的适用性等因素后，
得出了脉搏波在全身麻醉镇痛水平监测中具有优势的结论。其次，通过脉搏波的产生原理及微循环监测心血管状态的意义引出了容积脉搏波的应用价值，
详细说明了容积脉搏波的血流模型和检测原理。最后，根据波形形态分析了光电容积脉搏波与心输出量、外周阻力等生理信息的相关性，并简要阐述了脉搏波的特点。