...
之间差异表达的25个RNA，并基于该结果训练生成了一个逻辑回归预测模型。经验证，通过受试者工作特征曲线（receiver operating characteristic，ROC）得到该模型的曲线下面积（area under curve，AUC）数值可达0.86。
...
PlGF及PAPP-A等四种生物标志物的检查结果，对孕妇的PE病发风险进行了预测（$N$
\begin{landscape}
    \begin{longtblr}
        [
            theme          = {zju},
...
开发一款能够完成上述具体研究目标的基于PPG的PE识别分析软件系统。
\subsection{研究内容}
...
综合利用多种软件开发工具与软件开发思想，完成上述研究内容的软件分析载体的研究。在保证核心功能的基础上，进一步提高软件系统的拓展性与兼容性，
