...
\titletwolines{基于光电容积脉搏波的子痫}{前期识别模型的研究}
% \titleengtwolines{The research of preeclampsia }{recognition model based on photoplethysmography}
...
\newcommand{\inputgraduate}
{
    ...
    \bodystyle
    \inputbody{intro}
    \inputbody{preeclampsia}
    \inputbody{pulse_preprocess}
    \inputbody{features}
    \inputbody{models}
    \inputbody{results}
    \inputbody{summary}
